...
export default function NotaEditor({ mostraNotas , notaSelecionada, setNotaSelecionada}) {
  ...
  useEffect(() => {
    if(notaSelecionada.id){
      preencheModal();
      setNotaParaAtualizar(notaSelecionada);
      setModalVisivel(true);
      return
    }
    setNotaParaAtualizar(false);
  },[notaSelecionada])
//toda vez que o notaSelecioanda mudar ele vai rodar o useEffect novamente
              ...
              <View style={estilos.modalBotoes}>
                <TouchableOpacity style={estilos.modalBotaoSalvar} onPress={() => {
                ...
                </TouchableOpacity>
                  {
                    notaParaAtualizar ?
                    (  
                      <TouchableOpacity style={estilos.modalBotaoDeletar} onPress={() => { limparModal()}}>
                ...
                <TouchableOpacity style={estilos.modalBotaoCancelar} onPress={() => { deletaNota()}}>
